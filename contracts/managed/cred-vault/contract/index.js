...
class _CredentialData_0 {
  ...
  fromValue(value_0) {
    return {
      credType: _descriptor_0.fromValue(value_0),
      holderCommitment: _descriptor_0.fromValue(value_0),
      issuerId: _descriptor_0.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.credType).concat(_descriptor_0.toValue(value_0.holderCommitment).concat(_descriptor_0.toValue(value_0.issuerId)));
  }
}

const _descriptor_3 = new _CredentialData_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.credentialType) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named credentialType');
    }
    ...
    if (typeof(witnesses_0.issuerId) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named issuerId');
    }
    ...
    this.circuits = {
      registerIssuer: (...args_1) => {
        ...
        const issuerPublicKey_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerIssuer',
                                     'argument 1 (as invoked from Typescript)',
                                     'cred-vault.compact line 26 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(issuerPublicKey_0),
      ...
      issueCredential: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const holderCommitment_0 = args_1[1];
        const issuer_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('issueCredential',
                                     'argument 1 (as invoked from Typescript)',
                                     'cred-vault.compact line 31 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(holderCommitment_0.buffer instanceof ArrayBuffer && holderCommitment_0.BYTES_PER_ELEMENT === 1 && holderCommitment_0.length === 32)) {
          __compactRuntime.typeError('issueCredential',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'cred-vault.compact line 31 char 1',
                                     'Bytes<32>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(holderCommitment_0).concat(_descriptor_0.toValue(issuer_0)),
      ...
      verifyCredential: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verifyCredential',
                                     'argument 1 (as invoked from Typescript)',
                                     'cred-vault.compact line 51 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      revokeCredential: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('revokeCredential',
                                     'argument 1 (as invoked from Typescript)',
                                     'cred-vault.compact line 71 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(holderCommitment_0.buffer instanceof ArrayBuffer && holderCommitment_0.BYTES_PER_ELEMENT === 1 && holderCommitment_0.length === 32)) {
  ...
  _credentialType_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.credentialType(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('credentialType',
                                 'return value',
                                 'cred-vault.compact line 15 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _holderSecret_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('holderSecret',
                                 'return value',
                                 'cred-vault.compact line 16 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _issuerId_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.issuerId(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('issuerId',
                                 'return value',
                                 'cred-vault.compact line 17 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _salt_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('salt',
                                 'return value',
                                 'cred-vault.compact line 18 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _registerIssuer_0(context, partialProofData, issuerPublicKey_0) {
  ...
  _issueCredential_0(context, partialProofData, holderCommitment_0, issuer_0) {
    const credType_0 = this._credentialType_0(context, partialProofData);
    ...
    const credData_0 = { credType: credType_0,
                         holderCommitment: holderCommitment_0,
                         issuerId: issuer_0 };
    const commitment_0 = this._persistentCommit_0(credData_0, s_0);
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
  ...
  _verifyCredential_0(context, partialProofData) {
    ...
    const iId_0 = this._issuerId_0(context, partialProofData);
    const s_0 = this._salt_0(context, partialProofData);
    const computedHolderCommitment_0 = this._persistentHash_0(secret_0);
    const credData_0 = { credType: credType_0,
                         holderCommitment: computedHolderCommitment_0,
                         issuerId: iId_0 };
    const commitment_0 = this._persistentCommit_0(credData_0, s_0);
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
  ...
  _revokeCredential_0(context, partialProofData, holderCommitment_0, issuer_0) {
    const credType_0 = this._credentialType_0(context, partialProofData);
    const s_0 = this._salt_0(context, partialProofData);
    const credData_0 = { credType: credType_0,
                         holderCommitment: holderCommitment_0,
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'cred-vault.compact line 8 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    issuers: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'cred-vault.compact line 10 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({
  credentialType: (...args) => undefined,
  holderSecret: (...args) => undefined,
  issuerId: (...args) => undefined,
  salt: (...args) => undefined
});
